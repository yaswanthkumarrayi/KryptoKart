...
class DashboardScreen extends StatelessWidget {
      ...
      Row(children: [
        ...
        Container(
          ...
          child: Row(mainAxisSize: MainAxisSize.min, children: [
            ...
            Text('LIVE', style: AppTextStyles.caption.copyWith(color: AppColors.accent, fontSize: 9, fontWeight: FontWeight.w600)),
          ]),
        ),
      ]),
  ...
  Widget _cryptoMiniCardReal(String coinId, String symbol, String name, Map<String, dynamic> data, BuildContext context) {
  ...
  Widget _chart(DashboardLoaded s) {
    ...
    if (s.livePrices != null && s.livePrices!.isNotEmpty) {
      final bitcoinPrice = (s.livePrices!['bitcoin']?['inr'] as num?)?.toDouble() ?? 0;
      final ethereumPrice = (s.livePrices!['ethereum']?['inr'] as num?)?.toDouble() ?? 0;
      final tetherPrice = (s.livePrices!['tether']?['inr'] as num?)?.toDouble() ?? 0;
      ...
      totalValue = (bitcoinPrice * bitcoinHolding) + 
      ...
      portfolioSpots = List.generate(30, (i) {
        ...
        final variance = growth * 0.05 * (0.5 - (i % 7) / 14.0); // Add some realistic variance
      ...
      totalValue = 750000;
      portfolioSpots = List.generate(30, (i) {
        return FlSpot(i.toDouble(), 640000.0 + (i * 3800.0) + (i % 5 == 0 ? -8000 : 5000));
      });
    }
    
    final isPositive = portfolioSpots.isNotEmpty && 
